...
export function ProcessingMenu({
  ...
  const showWindowsPrivateAnalysis = __WINDOWS_TAURI_BUILD__ && desktop;
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start">
          ...
          <DropdownMenuSub>
            ...
            <DropdownMenuSubContent>
              ...
              {showWindowsPrivateAnalysis && (
                <>
                  <DropdownMenuItem
                    onSelect={() => onOpenWindowsPrivateAnalysis(0)}
                  >
                    경사·안전 분석
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onSelect={() => onOpenWindowsPrivateAnalysis(1)}
                  >
                    가시권 분석
                  </DropdownMenuItem>
                </>
              ...
              {show("processing.vector") && (
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent>
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("buffer")}
                    >
                      {t("toolbar.vectorTool.buffer")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("centroids")}
                    >
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("dissolve")}
                    >
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("simplify")}
                    >
                      {t("toolbar.vectorTool.simplify")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("reproject")}
                    >
                      {t("toolbar.vectorTool.reproject")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("explode")}
                    >
                      {t("toolbar.vectorTool.explode")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("aggregate")}
                    >
                      {t("toolbar.vectorTool.aggregate")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("smooth")}
                    >
                      {t("toolbar.vectorTool.smooth")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("grid")}
                    >
                      {t("toolbar.vectorTool.grid")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("voronoi")}
                    >
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("clip")}
                    >
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("union")}
                    >
                    ...
                    <DropdownMenuItem
                      onSelect={() => setVectorToolOpen("h3-grid")}
                    >
              ...
              {show("processing.network") && (
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent>
                    <DropdownMenuItem
                      onSelect={() => onOpenNetworkTool("isochrone")}
                    >
                      {t("toolbar.networkTool.isochrone")}
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onSelect={() => onOpenNetworkTool("od-matrix")}
                    >
              ...
              {showGeolibreTools && showGeolibreActions && (
                <DropdownMenuSeparator />
              )}
              {show("processing.geocode") && (
        ...
        {(showWhitebox || showGeolibre) && showWorkspacesOrServices && (
          <DropdownMenuSeparator />
        )}
        {show("processing.sqlWorkspace") && (
